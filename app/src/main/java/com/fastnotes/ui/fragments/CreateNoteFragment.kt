package com.fastnotes.ui.fragments
...
import com.fastnotes.helper.EventObserver
import com.fastnotes.helper.Resource
import com.fastnotes.ui.dialogs.AddUrlDialogs
import com.fastnotes.ui.viewmodels.CreateNoteViewModel
import com.fastnotes.utils.hideKeyboard
import com.fastnotes.utils.snackbar
import java.util.*
...
class CreateNoteFragment : Fragment(R.layout.fragment_create_note) {
    ...
    private fun copyTextNote() {
        ...
        if (clipBoard != null && clipData != null && input_note.text.toString().trim()
                .isNotEmpty()
        ) {
